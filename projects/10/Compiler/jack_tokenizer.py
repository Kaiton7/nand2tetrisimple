...
class JackTokenizer():
    ...
    def _readline(self):
        ...
        if line:
            self.remained_line = line.split(
                Tokens.LINE_COMMENT_START.token)[0].strip()
    ...
    def _pop_token_from_remained_line(self):
        ...
        print("remained_line", self.remained_line)
        print("..len = ", len(self.remained_line))
        for i in range(1, len(self.remained_line) + 1):
            print("remainedline:", self.remained_line, ",i:", i)
            ...
            if i == len(self.remained_line):
                ...
                if self.judge_token(self.remained_line):
                    ...
                    print("remained",self.remained_line)
